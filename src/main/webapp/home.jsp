...
<script type="text/javascript"
	src="http://yourjavascript.com/11873115711/jquery-1-12-4-min.js"></script>
<script rel="stylesheet" src="resources/js/index.js"></script>
<script type="text/javascript"
	src="http://yourjavascript.com/21051171187/jquery-touchswipe-min.js"></script>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	<nav class="navbar navbar-default navbar-fixed-top page-scroll"
		data-offset-top="427">
		<div class="container-fluid">
			...
			<div class="col-md-2 col-sm-4">
				<div id="logo-maior" class="">
					<img src="resources/image/logo-menu.png"
						class="page-scroll img-responsive" />
				</div>
				<div id="logo-menor" class="logotipo-menu">
					<img id="" class="brand-menu img-responsive"
						src="resources/image/logo-menu.png" />
				</div>
			</div>
			<div class="col-md-10">
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img src="resources/image/image-um.png" alt="Img 1"
										class="carro">
								</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 alinhamento-sobre">
					...
					<div class="col-md-12 formtacao-container-sobre">
						<div class="jumbotrom texto-barbearia">
							<p class="pull-right ">
							<h4>
								"O sonho começou a se desenvolver em 1993,quando me formei no
								curso de barbeiro no SINDICATO DOS OFICIAS BARBEIROS
								CABELEIREIROS E SIMILARES , depois de algum tempo trabalhando na
								profissão sentia que faltava algo,então resolvi fazer o curso de
								cabeleireiro. Então engressei no SENAC, na época só existia 2
								módulos entrei como auxiliar de.cabelereiro me formando
								08/05/1995.
								<p class="pull-right">Passando em seguida para o módulo de
									cabeleireiro de homens e de senhoras concluindo o curso por
									completo em 10/10/1995. Segui trabalhando sonhando em quando
									chegaria o dia de ser o patrão e dono do imóvel então em 2013
									apareceu a oportunidade que tanto esperava a compra do imóvel e
									o surgimento da BARBEARIA LEOPOLDINENSE situada no subúrbio do
									bairro da penha área da Leopoldina onde na década de.1960 era
									conhecida por ser um pólo industrial DA FABRICA CORTUME
									CARIOCA,que processava o couro para sapatos, bolsas etc!!! Onde
									se gerava centenas de empregos e também é talvez a mais famosa
									do bairro a nossa IGREJA DA PENHA,onde se tinha uma grande
									festa de duração de vários dias com devotos se espalhando pelo
									então conhecido bairro dourado. Histórias lindas se escuta do
									bairro em seus tempos áureos. Então surgiu a idéia do nome
									BARBEARIA LEOPOLDINENSE,por todas as histórias lindas que se
									tem do bairro que cresceu na área da Leopoldina."</p>
								</p>
							</h4>

						</div>
					</div>
					<div class="col-md-4 img-sobre-format">
						<img src="resources/image/image-funcionario.jpg"
							class="img-responsive img-quipe center-block" width="300"
							height="140">
					</div>
					<div class="col-md-8">
						<p class="panel panel-default pull-right frase-sobre">
							Espero um dia fazer parte dessa história desse bairro umilde
							porém conchegante de quem mora e conhece nunca mais esquece.quem
							sabe um dia a BARBEARIA LEOPOLDINENSE cresça como a Penha. <br>
							<small class="pull-center">'Paulo Sergio</small>
						</p>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<c:forEach var="funcionario" items="${sessionScope.equipe}">
						<div class="col-md-4">
							<div class="borda-funcinario">
								<img src="resources/image/${funcionario.foto}" alt="..."
								...
								<div class="caption descricao-funcionario">
									<h5>${funcionario.desc}</h5>
									<h6>${funcionario.tempoprof}</h6>
								</div>
							</div>
						</div>
					</c:forEach>
	...
	<section id="servicos" class="servicos-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 conteudo-edit" sytle="background-image:url("resources/image/fundo-barb.jpg");">
					<img src="resources/image/servicos.png" width="140" height="100"
						class="img-responsive center-block img-servicos">
					<!--<h1>Servicos</h1>-->
					<div class="row">
						<c:forEach var="servico" items="${sessionScope.servicos}">
						<div class="col-md-4">
							<figure>
								<img src="resources/image/${servico.imagem}"
									class="img-reponsive img-servicos-ativo" width="160"
									height="160">
							</figure>
							<p class="text-center">
								<strong><h4>${servico.descricao}</h4></strong>
							</p>
							<fmt:setLocale value = "pt_BR"/>
							<p><fmt:formatNumber type="CURRENCY" value="${servico.valor}"/></p>
						...
						<div class="tab-content">
								...
								<div class='row'>
									<div class='col-md-offset-2 col-md-8'>
										<div class="carousel slide" data-ride="carousel"
											...
											<div class="carousel-inner">
												<c:forEach var="comentario"  items="${sessionScope.comentarios}" varStatus="loop">
												<div class="item ${loop.index eq '0' ? 'active' : ''}">
													<blockquote>
														<div class="row">
															<div class="col-sm-3 text-center">
																<h5 class="media-heading text-uppercase reviews">${comentario.nome}</h5>
																<h6 class="media-heading text-uppercase reviews">${comentario.bairro}</h6>
															</div>
															<div class="col-sm-9">
																<small>${comentario.comentario} </small> 
																<c:forEach begin="1" end="${comentario.nota}">
							...
							<div class="tab-pane" id="account-settings">
								<form action="addComentario" method="post"
									class="form-horizontal" id="accountSetForm" role="form">
									...
									<div class="form-group">
										<label for="id_comentario" class="col-sm-2 control-label">Bairro</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="bairro"
												id="id_comentario" placeholder="Bairro">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control" rows="3" name="comentario"
												id="textArea" placeholder="Comentário"></textarea>
										</div>
									</div>
									...
									<input type="hidden" class="form-control" name="nota" id="nota">
								</form>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-edit">
							...
							<div class=" row text-center">
								...
								<p class="help-block">
									<small>Segunda a Sexta - 00 às 20h <br>Telefone:(21)
										3507-9469
								</p>
								</small>
							</div>
